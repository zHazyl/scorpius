...
public class FriendRequestServiceImplTest {
    ...
    public void shouldReturnNewFriendRequest() {
        ...
        // then
        MatcherAssert.assertThat(result.getSender(), is(sender));
        MatcherAssert.assertThat(result.getRecipient(), is(recipient));
        MatcherAssert.assertThat(result.getSentTime(), is(notNullValue()));
    ...
    public void friendChatShouldBeCreatedWhenAcceptFriendRequest() {
        ...
        // then
        MatcherAssert.assertThat(friendRequestRepository.getOne(1L).isAccepted(), is(true));
